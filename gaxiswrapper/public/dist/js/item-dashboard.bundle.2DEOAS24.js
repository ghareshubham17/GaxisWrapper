(() => {
  // frappe-html:/home/user/Projects/GAXis/frappe-bench/apps/gaxis/gaxis/stock/dashboard/item_dashboard.html
...
`;
  ...
  // frappe-html:/home/user/Projects/GAXis/frappe-bench/apps/gaxis/gaxis/stock/dashboard/item_dashboard_list.html
...
`;
  ...
  // ../gaxis/gaxis/stock/dashboard/item_dashboard.js
  frappe.provide("gaxis.stock");
  gaxis.stock.ItemDashboard = class ItemDashboard {
    constructor(opts) {
      $.extend(this, opts);
      this.make();
    }
      ...
      function handle_move_add(element, action) {
        ...
        if (disable_quick_entry) {
          ...
          if (action === "Add") {
            ...
            gaxis.stock.move_item(item, null, warehouse, actual_qty, rate, function() {
              me.refresh();
            });
          } else {
            gaxis.stock.move_item(item, warehouse, null, actual_qty, null, function() {
              me.refresh();
            });
          }
        }
  ...
  gaxis.stock.move_item = function(item, source, target, actual_qty, rate, callback) {
  ...
  // frappe-html:/home/user/Projects/GAXis/frappe-bench/apps/gaxis/gaxis/stock/page/warehouse_capacity_summary/warehouse_capacity_summary.html
...
`;
  ...
  // frappe-html:/home/user/Projects/GAXis/frappe-bench/apps/gaxis/gaxis/stock/page/warehouse_capacity_summary/warehouse_capacity_summary_header.html
...
//# sourceMappingURL=item-dashboard.bundle.2DEOAS24.js.map
